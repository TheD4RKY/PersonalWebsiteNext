...
<>
        <footer className={Style.footer} data-aos="fade-up" data-aos-duration="6000">
            <article className={Style.footer_column}>
                ...
                <img src="images/about_me.jpeg" className={Style.cards} data-aos="zoom-out" data-aos-delay="300" />
            ...
            <article className={Style.footer_column}>
                ...
                <img src="images/about_work.png" className={Style.cards} data-aos="zoom-out" data-aos-delay="300" />
